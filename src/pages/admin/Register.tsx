...
const AdminRegister: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden relative bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      {/* LEFT - FORM */}
      <div
        className="w-full md:w-1/2 flex flex-col items-center justify-start relative z-10 px-4 py-12 overflow-y-auto max-h-screen scrollbar-hide"
        style={{
          scrollbarWidth: 'none',
      ...
      >
        ...
        <form
          ...
          className="bg-white/85 backdrop-blur-xl rounded-[2rem] w-full max-w-[480px] px-12 py-10 border border-purple-200/40 relative z-10 animate-slide-up"
          style={{
        ...
        >
          ...
          {/* EMAIL */}
          <div className="mb-6">
            <label className="block text-sm font-semibold mb-2.5 text-gray-700 uppercase tracking-wide">Email</label>
          ...
          {/* NAME */}
          <div className="mb-6">
            <label className="block text-sm font-semibold mb-2.5 text-gray-700 uppercase tracking-wide">Nama Lengkap</label>
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-500 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* USERNAME */}
          <div className="mb-6">
            <label className="block text-sm font-semibold mb-2.5 text-gray-700 uppercase tracking-wide">Username</label>
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-500 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* PASSWORD */}
          <div className="mb-6">
            <label className="block text-sm font-semibold mb-2.5 text-gray-700 uppercase tracking-wide">Password</label>
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-500 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="hidden md:flex md:w-1/2 h-screen overflow-hidden relative sticky top-0 z-10">
